      ...
      <div className="mx-auto flex h-24 max-w-screen-xl items-center gap-6 px-4">
        ...
        <div className="flex flex-1 items-center justify-end md:justify-between">
          <nav aria-label="Global" className="hidden md:block">
            <ul className="flex items-center gap-4 lg:gap-6 text-sm min-[900px]:text-lg">
              <li>
          ...
          <div className="flex items-center gap-4">
            ...
            {isMenuOpen && (
              <div className="absolute top-24 right-4 bg-white shadow-lg rounded-md px-6 py-4 lg:hidden">
                <ul className="flex flex-col gap-4 text-sm">
                  ...
                  <li>
                    <Link to="/actualites" onClick={() => setIsMenuOpen(false)}>
                      Actualités
                    </Link>
                  </li>
                  <li>
