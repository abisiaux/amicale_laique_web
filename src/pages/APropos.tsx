  ...
  return (
    <div className="container mx-auto px-8 py-8 md:px-24">
      ...
      <section className="prose max-w-3xl mx-auto px-4">
        ...
        <p>
          Son siège social est installé au sein de l’école publique Jules Verne,
          77 avenue Jules Verne, 44 850 LIGNE.
        </p>
        ...
        <ul className="list-disc list-inside">
          <li>
            D’organiser des fêtes et des manifestations ayant pour objectif de
            récolter des fonds et contribuer ainsi aux frais qui incombent à
            l’école.
          </li>
          <li>
        ...
        <ul className="list-disc list-inside">
          <li>
            Du Conseil d’Administration ou Bureau soit 3 personnes minimum élues
            lors de l’assemblée générale (Président, Trésorier et Secrétaire)
          </li>
        ...
        <ul className="list-disc list-inside">
          ...
          <li>Décès</li>
          <li>
            Radiation prononcée par le Conseil d’Administration pour non-respect
            des statuts, l’intéressé ayant été invité à faire valoir ses droits
            de défense auprès du conseil d’administration.
          </li>
          <li>Dissolution de l’association</li>
        </ul>
        <p>
          Les membres qui cessent de faire partie de l’association pour une
          cause quelconque n’ont aucun droit sur l’actif social et celle-ci est
          entièrement dégagée à leur égard.
        </p>
        ...
        <p>
          ...
          l’Association, convoquée spécialement à cet effet, doit comprendre au
          moins la moitié plus un de ses membres. Si cette proportion n’est pas
          atteinte, l’Assemblée est convoquée de nouveau mais à 15 jours au
        ...
        <p>
          Le Conseil d’Administration peut se réunir en séance extraordinaire à
          la demande du Président ou du quart des membres.
        </p>
