            ...
            <div className="max-w-screen-xl container mx-auto px-4 text-sm ">
                <div className="flex justify-between flex-col md:flex-row gap-4 items-center">
                    ...
                    <div className="flex space-x-4">
                        <a href={FACEBOOK_URL} className="text-tertiary hover:text-(--secondary-color)" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
                            <FacebookLogo size={36} />
                        </a>
                        <a href={WHATSAPP_URL} className="text-tertiary hover:text-(--secondary-color)" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp">
                            <WhatsappLogo size={36} />
                        </a>
                        <a className="border-2 rounded-2xl p-1 text-tertiary h-8 my-auto" href={HELLOASSO_URL} target="_blank" rel="noopener noreferrer" aria-label="HelloAsso">
                            HelloAsso
                        </a>
                    </div>
                    <div className="flex">
